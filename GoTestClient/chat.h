...
private:
    ...
    MainWindowNew * mainwindow;//主窗口指针
    bool isread = false;
    int isdown;
    QPixmap pixmap;
    QPixmap mypixmap;
...
public:
    explicit Chat(QPixmap mypixmap,QPixmap pixmap,QString otheraccount,QString name,MainWindowNew * main, QWidget *parent = 0);
    QString getLocalIP();
    ...
    MainWindowNew *getMainwindow() const;
    void setMainwindow(MainWindowNew *value);
