...
#endif
Chat::Chat(QPixmap mypixmap,QPixmap pixmap,QString otheraccount,QString name,MainWindowNew * main,QWidget *parent) :
    QWidget(parent),
    ui(new Ui::Chat)
{
    ui->setupUi(this);
...
MainWindowNew *Chat::getMainwindow() const
{
    return mainwindow;
}

void Chat::setMainwindow(MainWindowNew *value)
{
    mainwindow = value;
}
